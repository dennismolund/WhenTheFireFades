        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectionCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    LeaderSeat = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    GameWinner = table.Column<int>(type: "int", nullable: false),
                    RoundCounter = table.Column<int>(type: "int", nullable: false),
                    SuccessCount = table.Column<int>(type: "int", nullable: false),
                    SabotageCount = table.Column<int>(type: "int", nullable: false),
                    ConsecutiveRejectedProposals = table.Column<int>(type: "int", nullable: false),
